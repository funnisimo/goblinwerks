...
async function showAbout() {
  ...
  y = buffer.wrapText(5, y+2, buffer.width - 10, "This version is based on the 5.7.11 release which can be found at: https://github.com/dungeons-of-moria/umoria/tree/v5.7.11");

  y = buffer.wrapText(5, y+2, buffer.width - 10, "This version is built using the GoblinWerks framework which can be found at: https://github.com/funnisimo/goblinwerks");
