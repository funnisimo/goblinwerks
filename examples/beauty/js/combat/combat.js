    ...
    await GW.io.dispatchEvent(ev, {
      ...
      enter() {
        if (COMBAT_COUNT > 2) {
          ...
          console.log('click: ', selected, count);
        }
      },
      dir(e) {
        if (e.dir) {
